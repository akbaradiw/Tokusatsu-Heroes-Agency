        ...
        <div className="lg:flex lg:justify-around lg:mx-auto lg:pt-10 grid ">
          ...
          <div className="lg:ms-20 lg:ps-20 pt-14 ">
            ...
            <p class="lg:mb-6 lg:ms-20 lg:text-lg text-sm pt-6 pb-3 ">
              ...
              Sentai, Ultraman, & Metal Heroes untuk meminjamkan kekuatannya
              guna membantu kalian. Lorem ipsum dolor sit amet, consectetur
              adipiscing elit. Sed euismod, nisl nec ultricies lacinia, nisl
              nisl aliquam nisl, nec euismod nisl nisl eu nisl. Sed euismod,
              nisl nec ultricies lacinia, nisl nisl aliquam nisl, nec euismod
              nisl nisl eu nisl.
